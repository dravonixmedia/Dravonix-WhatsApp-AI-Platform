...
/**
 * Production implementation of EntitlementRepository (ADR-0006): merges
 * plan_entitlements + company_entitlements (company-level taking precedence),
 * and computes current-period usage for the one usage-metered capability this
 * consumer cares about (monthly_messages).
 */
