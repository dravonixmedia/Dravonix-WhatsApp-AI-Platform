 ...
 * RPC (supabase/migrations/00000000000010_knowledge_search_rpc.sql). The company
 * filter is applied inside the SQL function itself, before ranking or limiting
 * (Master Prompt section 13/36).
 */
